...
app = Flask(__name__)
mydb = sqlite3.connect('static/corpus.db',check_same_thread=False) #Connects to database
...
def BookLocationPathBuilder(finaloutput):
    pathlist=[]
    for i in range(1,5):
        ID=finaloutput[i][0]
        path="BOOKS/"+str(ID)+".pdf"
...
def index():
    if request.method=="POST":
        ...
        [159, 'Bidyāsāgara, Īśvaracandra', 'Betalpanchabinshati', 7, 37.14],
